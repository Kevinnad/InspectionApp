...
import com.example.androidassignment.database.dao.TestInspectionDao;
...
@Database(entities = {InspectionDataModel.class, Data.class, TruckLoadingDataModel.class, TestInspectionModel.class}, version = 2)
...
public abstract class AppDataBase extends RoomDatabase {
    ...
    public abstract TestInspectionDao testInspectionDao();
}
